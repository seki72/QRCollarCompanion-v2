...
function TermsAndConditions() {
  return (
    <div className="mx-[2.5%] py-6">
      ...
      <h2 className="mb-4 text-3xl font-semibold">Interpretation and Definitions</h2>
      ...
      <ul className="mb-4 ml-4 list-disc">
        ...
        <li>
          <p>
            <strong>Application</strong> refers to Qrcollar companion, the software program provided by the
            Company.
          </p>
        </li>
        <li>
          <p>
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Qrcollar companion.
          </p>
        </li>
        <li>
          <p>
      ...
      <h2 className="mb-4 text-3xl font-semibold">Collecting and Using Your Personal Data</h2>
      <h3 className="mb-4 text-2xl font-semibold">Types of Data Collected</h3>
      <h4 className="mb-4 text-xl font-semibold">Personal Data</h4>
      <p className="mb-4">
      ...
      <h4 className="mb-4 text-xl font-semibold">Usage Data</h4>
      ...
      <h4 className="mb-4 text-xl font-semibold">Information Collected while Using the Application</h4>
      <p className="mb-4">
      ...
      <h3 className="mb-4 text-2xl font-semibold">Use of Your Personal Data</h3>
      ...
      <h3 className="mb-4 text-2xl font-semibold">Retention of Your Personal Data</h3>
      <p className="mb-4">
      ...
      <h3 className="mb-4 text-2xl font-semibold">Transfer of Your Personal Data</h3>
      <p className="mb-4">
      ...
      <h3 className="mb-4 text-2xl font-semibold">Delete Your Personal Data</h3>
      <p>
      ...
      <h3 className="mb-4 text-2xl font-semibold">Disclosure of Your Personal Data</h3>
      <h4 className="mb-4 text-xl font-semibold">Business Transactions</h4>
      <p className="mb-4">
      ...
      <h4 className="mb-4 text-xl font-semibold">Law enforcement</h4>
      <p className="mb-4">
      ...
      <h4 className="mb-4 text-xl font-semibold">Other legal requirements</h4>
      <p className="mb-4">
      ...
      <h3 className="mb-4 text-2xl font-semibold">Security of Your Personal Data</h3>
      <p className="mb-4">
      ...
      <h2 className="mb-4 text-3xl font-semibold">Children's Privacy</h2>
      <p className="mb-4">
      ...
      <h2 className="mb-4 text-3xl font-semibold">Links to Other Websites</h2>
      <p className="mb-4">
      ...
      <h2 className="mb-4 text-3xl font-semibold">Changes to this Privacy Policy</h2>
      <p className="mb-4">
      ...
      <ul className="mb-4 ml-4 list-disc">
        <li>
          By email: <a href="#">[email&#160;protected]</a>
        </li>
      </ul>
    </div>
  );
